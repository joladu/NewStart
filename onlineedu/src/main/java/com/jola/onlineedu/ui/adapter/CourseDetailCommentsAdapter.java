...
public class CourseDetailCommentsAdapter extends RecyclerView.Adapter<CourseDetailCommentsAdapter.ViewHolder> {
    ...
    public CourseDetailCommentsAdapter(Context context, List<ResCouserCommentList.ResultsBean> mList, DataManager dataManager) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(inflater.inflate(R.layout.item_comment_course_detail,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ResCouserCommentList.ResultsBean curBean = mList.get(position);

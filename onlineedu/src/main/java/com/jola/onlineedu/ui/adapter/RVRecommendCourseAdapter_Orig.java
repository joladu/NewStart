...
/**
 * Created by jola on 2018/12/3 backup
 */

public class RVRecommendCourseAdapter_Orig extends RecyclerView.Adapter <RVRecommendCourseAdapter_Orig.ViewHolder>{
    ...
    public RVRecommendCourseAdapter_Orig(Context context, List<ResCourseRecommendBean.ResultsBean> mList) {
